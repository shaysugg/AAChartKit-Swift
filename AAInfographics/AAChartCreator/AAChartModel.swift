...
public class AAChartModel: AAObject {
    ...
    ///please use titleStyle instead of it
    ...
    ///please use subtitleStyle instead of it
    ...
    ///please use dataLabelsStyle instead of it
    ...
    ///please use xAxisLabelsStyle or yAxisLabelsStyle instead of it
    public var axesTextColor: String?       //The labels font color of chart x axis and y axis

    ///This property is useless now, please remove it directly
...
//        axesTextColor = prop
    ...
    ///This setter function is useless now, please remove it directly
